...
(function (jQuery, ytp) {
	...
	jQuery.mbYTPlayer = {
		...
		defaults       : {
			...
			addRaster              : false,
			opacity                : 1,
			quality                : "hd720", //or â€œsmallâ€, â€œmediumâ€, â€œlargeâ€, â€œhd720â€, â€œhd1080â€, â€œhighresâ€
			mute                   : false,
			loop                   : true,
			showControls           : true,
		...
		buildPlayer: function (options) {
			...
			return this.each(function () {
				...
				if (YTPlayer.isBackground) {
					jQuery("body").css({position: "", minWidth: "100%", minHeight: "100%", zIndex: 1, boxSizing: "border-box"});
